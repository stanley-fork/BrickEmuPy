...
class GPL191Xdasm():
    def __init__(self, roots):
        ...
        self._instructions = (
            (GPL191Xdasm._brk, 1),
            (GPL191Xdasm._ora_ind_x, 2),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._ora_zp, 2),
            (GPL191Xdasm._asl_zp, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._php, 1),
            (GPL191Xdasm._ora_imm, 2),
            (GPL191Xdasm._asl_a, 1),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._ora_abs, 3),
            (GPL191Xdasm._asl_abs, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._bpl, 2),
            (GPL191Xdasm._ora_ind_y, 2),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._ora_zp_x, 2),
            (GPL191Xdasm._asl_zp_x, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._clc, 1),
            (GPL191Xdasm._ora_abs_y, 3),
            (GPL191Xdasm._dec_a, 1),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._ora_abs_x, 3),
            (GPL191Xdasm._asl_abs_x, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._jsr_abs, 3),
            (GPL191Xdasm._and_ind_x, 2),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._bit_zp, 2),
            (GPL191Xdasm._and_zp, 2),
            (GPL191Xdasm._rol_zp, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._plp, 1),
            (GPL191Xdasm._and_imm, 2),
            (GPL191Xdasm._rol_a, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._bit_abs, 3),
            (GPL191Xdasm._and_abs, 3),
            (GPL191Xdasm._rol_abs, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._bmi, 2),
            (GPL191Xdasm._and_ind_y, 2),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._and_zp_x, 2),
            (GPL191Xdasm._rol_zp_x, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._sec, 1),
            (GPL191Xdasm._and_abs_y, 3),
            (GPL191Xdasm._inc_a, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._ldm_zp, 3),
            (GPL191Xdasm._and_abs_x, 3),
            (GPL191Xdasm._rol_abs_x, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._rti, 1),
            (GPL191Xdasm._eor_ind_x, 2),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._eor_zp, 2),
            (GPL191Xdasm._lsr_zp, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._pha, 1),
            (GPL191Xdasm._eor_imm, 2),
            (GPL191Xdasm._lsr_a, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._jmp_abs, 3),
            (GPL191Xdasm._eor_abs, 3),
            (GPL191Xdasm._lsr_abs, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._bvc, 2),
            (GPL191Xdasm._eor_ind_y, 2),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._eor_zp_x, 2),
            (GPL191Xdasm._lsr_zp_x, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._cli, 1),
            (GPL191Xdasm._eor_abs_y, 3),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._eor_abs_x, 3),
            (GPL191Xdasm._lsr_abs_x, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._rts, 1),
            (GPL191Xdasm._adc_ind_x, 2),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._adc_zp, 2),
            (GPL191Xdasm._ror_zp, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._pla, 1),
            (GPL191Xdasm._adc_imm, 2),
            (GPL191Xdasm._ror_a, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._jmp_ind, 3),
            (GPL191Xdasm._adc_abs, 3),
            (GPL191Xdasm._ror_abs, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._bvs, 2),
            (GPL191Xdasm._adc_ind_y, 2),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._adc_zp_x, 2),
            (GPL191Xdasm._ror_zp_x, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._sei, 1),
            (GPL191Xdasm._adc_abs_y, 3),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._adc_abs_x, 3),
            (GPL191Xdasm._ror_abs_x, 3),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._sta_ind_x, 2),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._sty_zp, 2),
            (GPL191Xdasm._sta_zp, 2),
            (GPL191Xdasm._stx_zp, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._dey, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._txa, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._sty_abs, 3),
            (GPL191Xdasm._sta_abs, 3),
            (GPL191Xdasm._stx_abs, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._bcc, 2),
            (GPL191Xdasm._sta_ind_y, 2),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._sty_zp_x, 2),
            (GPL191Xdasm._sta_zp_x, 2),
            (GPL191Xdasm._stx_zp_y, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._tya, 1),
            (GPL191Xdasm._sta_abs_y, 3),
            (GPL191Xdasm._txs, 1),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._sta_abs_x, 3),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._ldy_imm, 2),
            (GPL191Xdasm._lda_ind_x, 2),
            (GPL191Xdasm._ldx_imm, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._ldy_zp, 2),
            (GPL191Xdasm._lda_zp, 2),
            (GPL191Xdasm._ldx_zp, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._tay, 1),
            (GPL191Xdasm._lda_imm, 2),
            (GPL191Xdasm._tax, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._ldy_abs, 3),
            (GPL191Xdasm._lda_abs, 3),
            (GPL191Xdasm._ldx_abs, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._bcs, 2),
            (GPL191Xdasm._lda_ind_y, 2),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._ldy_zp_x, 2),
            (GPL191Xdasm._lda_zp_x, 2),
            (GPL191Xdasm._ldx_zp_y, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._clv, 1),
            (GPL191Xdasm._lda_abs_y, 3),
            (GPL191Xdasm._tsx, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._ldy_abs_x, 3),
            (GPL191Xdasm._lda_abs_x, 3),
            (GPL191Xdasm._ldx_abs_y, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._cpy_imm, 2),
            (GPL191Xdasm._cmp_ind_x, 2),
            *([(GPL191Xdasm._dummy, 1)] * 2),
            (GPL191Xdasm._cpy_zp, 2),
            (GPL191Xdasm._cmp_zp, 2),
            (GPL191Xdasm._dec_zp, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._iny, 1),
            (GPL191Xdasm._cmp_imm, 2),
            (GPL191Xdasm._dex, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._cpy_abs, 3),
            (GPL191Xdasm._cmp_abs, 3),
            (GPL191Xdasm._dec_abs, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._bne, 2),
            (GPL191Xdasm._cmp_ind_y, 2),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._cmp_zp_x, 2),
            (GPL191Xdasm._dec_zp_x, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._cld, 1),
            (GPL191Xdasm._cmp_abs_y, 3),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._cmp_abs_x, 3),
            (GPL191Xdasm._dec_abs_x, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._cpx_imm, 2),
            (GPL191Xdasm._sbc_ind_x, 2),
            (GPL191Xdasm._div_zp_x, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._cpx_zp, 2),
            (GPL191Xdasm._sbc_zp, 2),
            (GPL191Xdasm._inc_zp, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._inx, 1),
            (GPL191Xdasm._sbc_imm, 2),
            (GPL191Xdasm._nop, 1),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._cpx_abs, 3),
            (GPL191Xdasm._sbc_abs, 3),
            (GPL191Xdasm._inc_abs, 3),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._beq, 2),
            (GPL191Xdasm._sbc_ind_y, 2),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._sbc_zp_x, 2),
            (GPL191Xdasm._inc_zp_x, 2),
            (GPL191Xdasm._dummy, 1),
            (GPL191Xdasm._sed, 1),
            (GPL191Xdasm._sbc_abs_y, 3),
            *([(GPL191Xdasm._dummy, 1)] * 3),
            (GPL191Xdasm._sbc_abs_x, 3),
            (GPL191Xdasm._inc_abs_x, 3),
            (GPL191Xdasm._dummy, 1)
        )
